...
// +kubebuilder:webhook:path=/mutate-workloads-alexeldeib-xyz-v1-demo,mutating=true,failurePolicy=fail,groups=workloads.alexeldeib.xyz,resources=demoes,verbs=create;update,versions=v1,name=mdemo.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-workloads-alexeldeib-xyz-v1-demo,mutating=false,failurePolicy=fail,groups=workloads.alexeldeib.xyz,resources=demoes,versions=v1,name=vdemo.kb.io
